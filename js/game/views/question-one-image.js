    ...
    return `<section class="game">
      ...
      <form class="game__content  game__content--wide">
        <div class="game__option">
          ...
          <label class="game__answer  game__answer--photo" ${debug.enable && this.question.answer.value === `photo` ? debug.styleRight : debug.styleWrong}>
            <input class="visually-hidden" name="question1" type="radio" value="photo">
            <span>Фото</span>
          </label>
          <label class="game__answer  game__answer--paint" ${debug.enable && this.question.answer.value === `photo` ? debug.styleWrong : debug.styleRight}>
